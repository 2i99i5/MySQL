...
CREATE TABLE users (
    ...
    adress_page VARCHAR(50) UNIQUE COMMENT 'адрес страницы, альтернатива id',
...
-- отметки друзей на media
DROP TABLE IF EXISTS friend_marks;
CREATE TABLE friend_marks (
	initiator_user_id BIGINT UNSIGNED NOT NULL,
    target_user_id BIGINT UNSIGNED NOT NULL,
    media_id BIGINT UNSIGNED NOT NULL,
    `status` ENUM('sent', 'approved', 'declined'),
    rectangle_place_x SMALLINT UNSIGNED NOT NULL,
    rectangle_place_y SMALLINT UNSIGNED NOT NULL,
    rectangle_size_x SMALLINT UNSIGNED NOT NULL,
    rectangle_size_y SMALLINT UNSIGNED NOT NULL,
	requested_at DATETIME DEFAULT NOW(),
	confirmed_at DATETIME,
...
-- дарение подарка
DROP TABLE IF EXISTS giving_gift;
CREATE TABLE giving_gift (
	initiator_user_id BIGINT UNSIGNED NOT NULL,
    target_user_id BIGINT UNSIGNED NOT NULL,
    ...
    PRIMARY KEY (gift_id, target_user_id, initiator_user_id),
